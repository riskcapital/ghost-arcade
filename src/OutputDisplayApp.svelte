...
{#if !connected}
  <!-- Connection-status badge. Pre-v0.6.3 this also showed an
       ...
       non-actionable. Now only fires for genuine fault states.
       Press-S stats overlay below still covers diagnostics. -->
