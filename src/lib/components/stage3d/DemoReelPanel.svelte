...
<style>
  ...
  .tray-head {
    color: #8a8fa3; text-transform: uppercase; font-size: 10px;
  ...
  .tpl-card {
    ...
    padding: 6px 8px; cursor: grab; font-size: 12px;
    text-align: left;
  }
  ...
  .shot-thumb.placeholder {
    display: flex; align-items: center; justify-content: center;
    font-size: 26px; color: #4a4f66;
  }
  .shot-meta { display: flex; flex-direction: column; padding: 5px 7px; gap: 2px; }
  .shot-name { font-weight: 600; font-size: 11px; }
  .shot-move { color: #8a8fa3; font-size: 10px; }
  .shot-del {
