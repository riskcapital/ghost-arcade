...
<style>
  ...
  .ss-title { font-size: 10px; color: var(--accent-secondary, #FF8585); letter-spacing: 0.6px; text-transform: uppercase; font-weight: 700; }
  .ss-sub   { font-size: 9px; color: #555; }

  .ss-row { display: flex; align-items: center; gap: 6px; }
  .ss-label { font-size: 9px; color: #666; width: 50px; }
  select {
    flex: 1;
    background: #0a0612;
  ...
  .ss-active-name { flex: 1; font-size: 10px; color: var(--accent-secondary, #FF8585); }
