...
export const MOBILE_SHADERS: MobileShader[] = [
  ...
  { id: 'dm-plasma-flow',         path: 'ISF/DM-PlasmaFlow.fs',                     name: 'Plasma Flow',      category: 'fluid',   audioNative: false },
  { id: 'dm-kaleidoscope',        path: 'ISF/DM-Kaleidoscope.fs',                   name: 'Kaleidoscope',     category: 'pattern', audioNative: false },
  { id: 'dm-aurora-borealis',     path: 'ISF/DM-AuroraBorealis.fs',                 name: 'Aurora Borealis',  category: 'fluid',   audioNative: false },
  { id: 'dm-liquid-metal',        path: 'ISF/DM-LiquidMetal.fs',                    name: 'Liquid Metal',     category: 'fluid',   audioNative: false },
  { id: 'dm-tunnel',              path: 'ISF/DM-Tunnel.fs',                         name: 'Tunnel',           category: 'kinetic', audioNative: false },
  { id: 'dm-neon-lines',          path: 'ISF/DM-NeonLines.fs',                      name: 'Neon Lines',       category: 'pattern', audioNative: false },
  { id: 'sm-fireflies',           path: 'ISF/SM-Fireflies.fs',                      name: 'Fireflies',        category: 'kinetic', audioNative: false },
  { id: 'sm-lava-lamp-blobs',     path: 'ISF/SM-LavaLampBlobs.fs',                  name: 'Lava Lamp',        category: 'fluid',   audioNative: false },
  { id: 'sm-bouncing-balls',      path: 'ISF/SM-BouncingBalls.fs',                  name: 'Bouncing Balls',   category: 'kinetic', audioNative: false },
  { id: 'sm-breathing-membrane',  path: 'ISF/SM-BreathingMembrane.fs',              name: 'Breathing',        category: 'fluid',   audioNative: false },
];
