/*{
    ...
    "INPUTS": [
        ...
        { "NAME": "foldCount", "TYPE": "float", "DEFAULT": 6.0, "MIN": 1.0, "MAX": 9.0, "LABEL": "Fold Iterations" },
...
// Single channel raytrace for chromatic aberration
float traceChannel(vec3 ro, vec3 rd, float t) {
    float dist = 0.0;
    for (int i = 0; i < 70; i++) {
        vec3 pos = ro + rd * dist;
